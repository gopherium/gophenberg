...
func TestContentAPIAnswersTheHandshakeWithoutASession(t *testing.T) {
	...
	if !strings.Contains(body, `"kit":["0.9.0","0.10.0","0.11.0","0.12.0","0.13.0","0.14.0","0.15.0"]`) {
...
func TestContentAPIAdvertisesTheTypesItServes(t *testing.T) {
	...
	if !slices.Equal(handshake.Kit, []string{"0.9.0", "0.10.0", "0.11.0", "0.12.0", "0.13.0", "0.14.0", "0.15.0"}) {
