...
Apache-2.0 ([LICENSE](LICENSE)); every file carries an `SPDX-License-Identifier: Apache-2.0` header. Built frontend bundles include GPL-2.0-or-later `@wordpress/*` packages and are conveyed under GPLv3 terms; see [README](README.md).
